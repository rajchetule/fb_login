                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" action="{{ route('member-add') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class=" col-md-6">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputShopName" name="shop_name" placeholder="Enter Shop name">
                                            </div>
                                        </div>
                                        <div class=" col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputContact" name="contact" placeholder="Enter contact number">
                                            </div>
                                        </div>
                                        <div class=" col-md-6">
                                            <div class="form-group">
